public class Tilecoder {
	...
	public static void tilecode(double x1, double x2, int[] tilecodeIndices) {
		...
		System.out.print("standard x1: " + standardX1 + "\n");
		System.out.print("standard x2: " + standardX2 + "\n");
		...
		for (int i = 0; i < numOfTilings; i++) {
			...
			System.out.print("tile x1: " + tileNumX1 + "\n");
			System.out.print("tile x2: " + tileNumX2 + "\n");
