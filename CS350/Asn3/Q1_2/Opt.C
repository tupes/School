...
template <> string Opt::OptT<bool>::get_type() const { return "bool";   }
template <> string Opt::OptT<int>::get_type() const { return "int";   }
template <> string Opt::OptT<double>::get_type() const { return "double";   }
template <> string Opt::OptT<string>::get_type() const { return "string";   }